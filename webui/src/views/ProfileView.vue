                ...
                <div class="card mb-3" v-for="user in this.profile.followers" v-if="this.profile.followers != null">
                  <div class="card-body d-flex align-items-center justify-content-between">
                    <div class="me-5 p-2 bd-highlight">
                      <RouterLink :to="'/profile/' + user.userID" class="nav-link" :us="user.userID" data-dismiss="modal"
                        @click="this.us = user.userID; this.load()">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body overflow-auto">
          ...
          <div class="card mb-3" v-for="c in modalComments.comments">
            <div class="container">
              <div class="row p-3">
                <RouterLink :to="'/profile/' + c.user.userID" class="nav-link" :us="c.user.userID" data-dismiss="modal"
                  @click="this.us = c.user.userID; this.load()">
                  <div class="col-md-8">
              ...
              <div class="row p-2">
                <div class="col-9 col-md-9"><button type="button" class="btn btn-outline-danger delete-btn"
                    v-if="c.user.userID == this.myID" @click="this.deleteComment(c)">Delete comment</button></div>
